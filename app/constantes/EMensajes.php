<?php
/*PASO 41 establecemos una clasee que contenga todos los mensaje  necesarios del sistema esto en base a valores constantes
que determinaran si se logro o no una accion; y en base a esto el mensaje que el sistema debe de emitir*/
class EMensajes {
    //declaramos constantes en base a los posibles estados de comprobacion que tenemos en nuestro controlador
    ...
    public static function getMensaje($codigo) {
        switch ($codigo) {
            /*dentro de este swich evaluaaos el codigo obtenido en base a una comprobacion en nuestro controladores
            en base al valor de la constante que recibe definimos todos los mensaje utilizados en la aplicacion*/

            //retornamos al metodo respuesta($codigo, $mensaje) en base a casa caso y los valores correspondientes
            //usamos $codigo como una forma de verificacion 1=true -1=false  0= null
